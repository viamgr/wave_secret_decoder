...
class SecretDetectorTest {
    ...
    fun decodeFirstFile_shouldWorks() = runBlocking {
        getFileFromPath("file_1.wav")!!
            .findSecretMessage()
            .first()
            .let {
                Assert.assertEquals(EXPECTED_SECRET_MESSAGE, it)
            }
